...
public class Meal {
    ...
    public Meal(String name, String description, String category, String subCategory, Map<String, Double> portionPrices, Double rating, Boolean availability, List<String> options, List<String> images) {
